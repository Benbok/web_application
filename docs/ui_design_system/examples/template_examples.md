...
## 2. Шаблон подтверждения удаления плана обследования

### Описание
Шаблон для подтверждения удаления/отмены плана обследования с предупреждением и информацией о последствиях.

## 3. Шаблон подтверждения удаления документов

### Описание
Шаблон для подтверждения удаления документов с подробной информацией о документе и предупреждениями о последствиях. **Обновлен для использования карточки на всю ширину страницы.**
...
- **Информационные блоки** с детальной информацией
